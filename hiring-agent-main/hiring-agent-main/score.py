...
def main(pdf_path, role: Role, output_json: bool = False):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--json",
        action="store_true",
        help="Print the raw evaluation results in JSON format and exit.",
    )
    parser.add_argument(
        "--init-role",
        metavar="NAME",
    ...
    main(args.pdf_path, role, output_json=args.json)
